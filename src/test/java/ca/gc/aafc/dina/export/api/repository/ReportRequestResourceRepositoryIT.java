...
public class ReportRequestResourceRepositoryIT extends BaseIntegrationTest {
  ...
  public void create_onSequenceSubmissionCSVReportRequest_requestAccepted() {
    ...
    Map<String, Object> payload = Map.of(
      ...
      "seq-batch", JsonAPITestHelper.toJsonAPIMap("seq-batch", Map.of("name", "SeqBatch1"),
        JsonAPITestHelper.toRelationshipMap(
            JsonAPIRelationship.of("region", "region",
              "c35a44ce-ade3-45bd-8c67-8927bca94a8c")),
      ...
      "included", Map.of(
        ...
        "region", List.of(JsonAPITestHelper.toJsonAPIMap("region", Map.of("symbol", "ITS"),"c35a44ce-ade3-45bd-8c67-8927bca94a8c"))
      ));
