...
----
{
  "functions": {"latLong": {"functionDef": "CONVERT_COORDINATES_DD","params": {"column": "collectingEvent.eventGeom"}}}
}
----
...
----
{
  "functions": {"link": {"functionDef": "CONCAT","params": {"items": ["url", "id"], "constants": {"url": "http://localhost/entry"}, "separator": "/"}}}
}
----
